...
public class GapAnalyzer {
    ...
    public GapReport analyze(List<ScenarioRow> matrix, List<MethodDeclaration> testMethods) {
        ...
        return new GapReport(matrix.size(), covered.size(), coveragePercent, strengthPercent, missing, covered);
    }
