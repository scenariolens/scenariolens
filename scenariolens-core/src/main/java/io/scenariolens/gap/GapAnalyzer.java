...
public class GapAnalyzer {
    ...
    public GapReport analyze(String methodName, List<ScenarioRow> matrix, List<MethodDeclaration> testMethods) {
        ...
        return new GapReport(methodName, matrix.size(), covered.size(), coveragePercent, strengthPercent, missing, covered);
    }
